...
export const ALLIANCE_TOKENS: LotrAllianceTokenDef[] = [
  { id: "AT-ELVES-1", name: "Yellow Take Turn", race: "ELVES", effect: "When you play a Yellow card, take another turn after finishing this one.", faceUp: false },
  { id: "AT-ELVES-2", name: "Red Any Region", race: "ELVES", effect: "When you play a Red card, you may place all concerned Units in any 1 of the 7 regions.", faceUp: false },
  { id: "AT-ELVES-3", name: "Wildcard Skill", race: "ELVES", effect: "Once per turn, benefit from any Skill.", faceUp: false },
  ...
  { id: "AT-HOBBITS-2", name: "Blue One Unit", race: "HOBBITS", effect: "When you play a Blue card, also place 1 Unit in any region.", faceUp: false },
  { id: "AT-HOBBITS-3", name: "Chain Three Coins", race: "HOBBITS", effect: "When you play a card using a chaining symbol, take 3 Coins from the reserve.", faceUp: false },
  { id: "AT-ENTS-1", name: "Take Turn", race: "ENTS", effect: "Take another turn after finishing this one.", faceUp: false },
  { id: "AT-ENTS-2", name: "Remove Fortress", race: "ENTS", effect: "Remove 1 enemy Fortress from any region, return to opponent.", faceUp: false },
  { id: "AT-ENTS-3", name: "Three Maneuvers", race: "ENTS", effect: "Choose 3 times between: Remove 1 enemy Unit / Opponent loses 1 Coin / Complete 1 movement.", faceUp: false },
  { id: "AT-DWARVES-1", name: "No Fortress Cost", race: "DWARVES", effect: "When you play a Landmark tile, ignore the additional Coin cost.", faceUp: false },
  { id: "AT-DWARVES-2", name: "Landmark Take Turn", race: "DWARVES", effect: "When you play a Landmark tile, take another turn after finishing this one.", faceUp: false },
  { id: "AT-DWARVES-3", name: "Green Two Movements", race: "DWARVES", effect: "When you play a Green card, also complete 2 movements on the central board.", faceUp: false },
  { id: "AT-HUMANS-1", name: "Yellow Ring", race: "HUMANS", effect: "When you play a Yellow card, also move your quest character 1 space.", faceUp: false },
  { id: "AT-HUMANS-2", name: "Red Extra Unit", race: "HUMANS", effect: "When you play a Red card, place 1 additional Unit in the chosen region.", faceUp: false },
  { id: "AT-HUMANS-3", name: "Discard Double", race: "HUMANS", effect: "When you discard a card, take 2x the chapter coins (2/4/6) from the reserve.", faceUp: false },
  { id: "AT-WIZARDS-1", name: "Two Rings", race: "WIZARDS", effect: "Move your quest character 2 spaces.", faceUp: false },
  { id: "AT-WIZARDS-2", name: "Two Units", race: "WIZARDS", effect: "Place 2 Units in 1 region, or 1 Unit in 2 regions.", faceUp: false },
  { id: "AT-WIZARDS-3", name: "Take Discard", race: "WIZARDS", effect: "Take all discard cards, secretly choose 1, play it for free.", faceUp: false },
];
